...
import TimeCardInfo from "./TimeCardDisplay/TimeCardInfo";
import TimeCardActions from "./TimeCardDisplay/TimeCardActions";
...
const TimeCardDisplay: React.FC<TimeCardDisplayProps> = ({
  ...
  const { timeCard, isWorking, onStartWork, onEndWork } = useTimeCard(
    initialTimeCard,
    initialIsWorking,
    userId
  );
  ...
  return (
    <Box>
      <TimeCardInfo timeCard={timeCard} />
      <TimeCardActions
        isWorking={isWorking}
